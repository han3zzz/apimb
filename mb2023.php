...
class MBBANK
{
    ...
    public function get_lsgd2($user, $session_id,$deviceId,$account, $day)
    {
        ...
        'Deviceid: elerooyy-mbib-0000-0000-2024011210190879',
            'sec-ch-ua: "Chromium";v="104", " Not A;Brand";v="99", "Google Chrome";v="104"',
            'sec-ch-ua-mobile: ?0',
            'sec-ch-ua-platform: "Windows"',
            'Sec-Fetch-Dest: empty',
            'Sec-Fetch-Mode: cors',
            'Sec-Fetch-Site: same-origin',
            'X-Request-Id: ' . $user . '-' . date("Ymd") . '11562718',
            'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Safari/537.36',
        );
         $Action2 = 'https://online.mbbank.com.vn/retail_web/common/getTransactionHistory';
        $Action = 'https://online.mbbank.com.vn/api/retail-transactionms/transactionms/get-account-transaction-history';
        $Data = '{
            "toDate" : "' . date("d/m/Y") . '",
            "accountNo" : "' . $account . '",
            "sessionId" : "' . $session_id . '",
            "fromDate" : "' . date("d/m/Y",strtotime("$day days ago")) . '",
            "refNo" : "dailysieure.com-2024011213000253",
